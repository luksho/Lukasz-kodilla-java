...
public class CrudAppTestSuite {
    private static final String BASE_URL = "http://luksho.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        final String TRELLO_BOARD_URL = "https://trello.com/lukasz567/boards";
        ...
        Thread.sleep(1000);
        driverTrello.get(TRELLO_BOARD_URL);
        Thread.sleep(2000);
